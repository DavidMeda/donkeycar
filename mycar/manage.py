...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if model_path:
        ...
        kl = dk.utils.get_model_by_type(model_type, cfg, model_path)
        ...
        if '.h5' in model_path or '.uff' in model_path or 'tflite' in model_path or '.pkl' in model_path:
            ...
            print("Pytorch model laod extensin .pth")
        else:
    ...
    class DriveMode:
        def run(self, mode,
            ...
            if mode == 'user':
                ...
                #print("angle: "+str(pilot_angle))
                #print("throttle: "+str(pilot_throttle * cfg.AI_THROTTLE_MULT))
