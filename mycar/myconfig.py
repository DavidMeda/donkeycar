...
STEERING_RIGHT_PWM = 345        #pwm value for full right steering
# 
...
THROTTLE_REVERSE_PWM = 345      #pwm value for max reverse throttle
# 
...
# # tensorflow models: (linear|categorical|tflite_linear|tensorrt_linear|lane_model|nvidia(66x200))
# # pytorch models: (resnet18|VGG)
...
# 
# # AUGMENTATION Region of interest cropping
# #Augmentations and Transformations
# #MULTIPLY: This augmenter can be used to make images lighter or darker.
# #BLUR: Augmenter to blur images using gaussian kernels
# #
PREPROCESS_IMAGE = False
#AUGMENTATIONS = ['MULTIPLY', 'BLUR', 'GREYSCALE', 'CONTRAST', 'SHARPEN', 'EMBOSS', 'CANNY_EDGES']
#AUGMENTATIONS = ['MULTIPLY', 'CONTRAST', 'BLUR', 'SHARPEN','EMBOSS']

#TRANSFORMATIONS = ['CROP',  'TRAPEZE']         # uncomment when using the cropped models
#ROI_CROP_TOP = 45                    #the number of rows of pixels to ignore on the top of the image
#ROI_CROP_BOTTOM = 0                 #the number of rows of pixels to ignore on the bottom of the image
#ROI_CROP_RIGHT = 0                    #the number of columns of pixels to ignore on the top of the image
 #ROI_CROP_LEFT = 0                 #the number of rows of columns to ignore on the bottom left the image
#
# 
...
#JOYSTICK_MAX_THROTTLE = 0.80         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
#AI_LAUNCH_DURATION = 0.2            # the ai will output throttle for this many seconds
#AI_LAUNCH_THROTTLE = 1.5            # the ai will output this throttle value
#AI_LAUNCH_ENABLE_BUTTON = 'right_shoulder'      # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
# AI_LAUNCH_KEEP_ENABLED = False      # when False ( default) you will need to hit the AI_LAUNCH_ENABLE_BUTTON for each use. This is safest. When this True, is active on each trip into "local" ai mode.
# 
# #Scale the output of the throttle of the ai pilot for all model types.
#AI_THROTTLE_MULT = 0.5              # this multiplier will scale every throttle value for all output from NN models
# 
# #Path following
